...
<body id="page-top">
  ...
  <div id="wrapper">
    ...
    <ul class="navbar-nav sidebar sidebar-light accordion" id="accordionSidebar">
       ...
       <!-- Sidebar - Brand -->
    <a class="sidebar-brand d-flex align-items-center justify-content-center" href="?page=home2">
  ...
  <!--sidebar start-->
    ...
    <li class="d-flex align-items-center justify-content-center">
        <a class="nav-link">
		 ...
		 <li class="nav-item ">
        <a class="nav-link">
         	<div class="d-flex align-items-center justify-content-center" class="name"><span class="text-primary fw-bold" ><?php echo  $data['nama'];?></span></div></font>
	   ...
	   <li class="nav-item">
        ...
        <div id="collapseData" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item" href="?page=dataKaryawanAdmin">Data Karyawan</a>
          </div>
        </div>
      </li>
      <!-- Divider -->
 ...
 <form
        ...
        <div class="container-fluid">
         ...
         if ($page == "dataKaryawanAdmin") {
          if ($aksi == "") {
            include "page/dataKaryawanAdmin/karyawan.php";
          }
           if ($aksi == "tambahkaryawan") {
            include "page//dataKaryawanAdmin/tambahkaryawan.php";
          }
           if ($aksi == "ubahkaryawan") {
            include "page//dataKaryawanAdmin/ubahkaryawan.php";
          }
          
           if ($aksi == "hapuskaryawan") {
            include "page//dataKaryawanAdmin/hapuskaryawan.php";
          }
        }
