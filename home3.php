                ...
                <div class="container-fluid">
                    ...
                    <div class="card shadow mb-4" style="margin-top: 1rem;">
                        <div class="card-body">
                            ...
                            <p>Selamat datang <span><?= $data['nama'];?></span> di MyTeams, disini anda login menggunakan akun yang memiliki level superadmin, admin memiliki segala wewenang yang ada di web ini maka dari itu manfaatkan kepercayaan kami kepada anda, jangan sia sia kan kepercayaan kami kepada anda, Terimakasih... :)</p>
                        </div>
                    </div>
...
Highcharts.chart('chart_salary', {
    ...
    xAxis: {
        categories: ['UI/UX', 'FE', 'BE', 'Fullstack', 'DE', 'PO', 'PM'],
        labels: {
            skew3d: true,
            style: {
                fontSize: '16px'
