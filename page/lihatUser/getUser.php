            ...
            <div class="card-body">
              <div class="table-responsive">
                            ...
                            <div class="form-group">
                               <div class="form-line">
                                <input type="number" name="nik" value="<?php echo $tampil['nik']; ?>" class="form-control" disabled />
							...
							if (isset($_POST['simpan'])) {
								...
								$sql = $koneksi->query("update users set username='$username', nama='$nama', telepon='$telepon', password='$password', foto='$foto' where id='$id'"); 
								...
								if ($sql) {
									?>
                                        ...
                                        window.location.href= "?page=lihatUser&aksi=getUser&id=<?php echo $data['id'] ?>"
										</script>
								...
								$sql = $koneksi->query("update users set username='$username', nama='$nama', telepon='$telepon' where id='$id'"); 
